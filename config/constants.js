...
database = {
    adasmentors : {
        welcomeMessage : "Welcome to the Ada’s Mentors workspace! The goal of Ada’s Mentors is to mentor underprivileged students lacking the confidence and exposure to university and the application process.",
        workspaceRules : ['Currently there are no rules in this Workspace'],
        roles : [],
        training : [],
        resources : {adasMentorsWebsite:{url: "https://sites.google.com/ualberta.ca/adas-mentors-wiki/home"}},
    ...
    adasteam :{
        ...
        roles : [],
        training : [],
        resources : {adasTeamExecResource : {url : "https://sites.google.com/ualberta.ca/adas-team-wiki/home"}},
...
module.exports = { updateInfo, database }
